class Wapi(PokemonCharacter):
    ...
    def __init__(self):
        ...
        super().setSecondAttack(Llanto())
        super().setMainAttack(Autodestruccion())
    ...
    def mainAttack(self):
        attackMessage = "Wapi {}".format(super().getMainAttack())
        return attackMessage

    def secondAttack(self):
        attackMessage = "Wapi {}".format(super().getSecondAttack())
        return attackMessage
