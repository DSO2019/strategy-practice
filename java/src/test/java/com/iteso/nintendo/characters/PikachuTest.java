...
public class PikachuTest {
    ...
    public void maintAttackTest() {
        assertEquals("Attacking opponent with Quick Attack causing a damage of 6", pikachu.mainAttack());
    }

    /** Second attack test. */
    @Test
    public void secondAttackTest() {
        assertEquals("Attacking opponent with Impactrueno causing a damage of 13", pikachu.secondAttack());
    }
    ...
    public void getMainAttackDamageTest() {
        assertEquals(6, pikachu.getMainAttackDamage());
    }

    /** Second Damage test */
    @Test
    public void getSecondAttackDamageTest() {
        assertEquals(13, pikachu.getSecondAttackDamage());
    }
