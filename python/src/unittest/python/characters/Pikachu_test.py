...
class Pikachu_test(unnitest.TestCase):
    ...
    def test_mainAttack(self):
        self.assertEqual("Attacking opponent with Quick Attack causing a damage of 6",self.character.funMainAttack())

    def test_secondAttack(self):
        self.assertEqual("Attacking opponent with Impactrueno causing a damage of 13",self.character.funSecondAttack())
   
    def test_defend(self):
        self.assertEqual("Defending attack, damage caused is 0 new HP is 100",self.character.defend(5))
