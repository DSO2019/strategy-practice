...
class CharmanderTest(unittest.TestCase):
    ...
    def test_type(self):
        self.assertEquals("Fuego", self.charmander.getType())

    def test_evolution(self):
        self.assertEquals(True, self.charmander.isHasEvolution())

    def test_getMain(self):
        self.assertEquals("Lanzallamas", self.charmander.getMainAttack())

    def test_getSecondary(self):
        self.assertEquals("Pirotecnia", self.charmander.getSecondAttack())

    def test_getMainDamage(self):
        self.assertEquals(70, self.charmander.getMainAttackDamage())

    def test_getSecondDamage(self):
        self.assertEquals(70, self.charmander.getSecondAttackDamage())
