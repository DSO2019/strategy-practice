...
public abstract class PokemonCharacter {
     ...
     * Main attack.
     */
    private AttackBehavior mainAttack;
    /**
     * Second life.
     */
    private AttackBehavior secondAttack;
    /**
     * @return main attack behavior.
     */
    public AttackBehavior getMainAttackBehavior() {
        return this.mainAttack;
    }
    /**
     * @return secondary attack behavior.
     */
    public AttackBehavior getSecondAttackBehavior() {
        return this.secondAttack;
    }
    /**
     * @param ab new attack behavior.
     */
    public void setMainAttackBehavior(final AttackBehavior ab) {
        this.mainAttack = ab;
    }
    /**
     * @param ab2 new attack behavior.
     */
    public void setSecondaryAttackBehavior(final AttackBehavior ab2) {
    ...
    /**
     * @param attack Either main or second.
     * @param newAttack the attack behavior.
     */
