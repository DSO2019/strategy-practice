...
public abstract class PokemonCharacter {
     ...
     */
    public final void setHasEvolution(
     ...
     */
    public final void setSecondAttack(
            final Attack newSecondAttack) {
     ...
     */
    public final void setDefenseMultiplier(
            final double newDefenseMultiplier) {
