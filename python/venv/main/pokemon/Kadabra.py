...
from main.pokemon.Firepunch import *
...
class Charmander(PokemonCharacter):
    def __init__(self):
        ...
        self.firepunch = Firepunch()
        self.tackle = Tackle()
        self.setType("psytic")
        self.setName("Kadabra")
        self.setHasEvolution(true)
        self.setMainAttack(self.firepunch.doAttack())
        ...
        self.setMainAttackDamage(self.firepunch.attackDMG())
