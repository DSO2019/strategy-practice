...
from attacks.Airslash import *
from attacks.Aeroblast import *


class Lugia(PokemonCharacter):
    def __init__(self):
        self.HIT_POINTS = 65
        self.DEFENSE_MULTIPLIER = 0.6
        self.airslash = Airslash()
        self.aeroblast = Aeroblast()
        self.setType('air')
        self.setName('Lugia')
        self.setHasEvolution(False)
        self.setMainAttack(self.airslash)
        self.setSecondAttack(self.aeroblast)
        self.setHitPoints(self.HIT_POINTS)
        self.setDeffenseMultiplier(self.DEFENSE_MULTIPLIER)
        self.setMainAttackDamage(self.airslash.getAttackDamage())
        self.setSecondAttackDamage(self.aeroblast.getAttackDamage())
